...
| Target | Asset |
| --- | --- |
| `x86_64-unknown-linux-musl` | `ironcache-<ver>-x86_64-unknown-linux-musl.tar.gz` |
| `aarch64-unknown-linux-musl` | `ironcache-<ver>-aarch64-unknown-linux-musl.tar.gz` |
| `x86_64-unknown-linux-gnu.2.17` | `ironcache-<ver>-x86_64-unknown-linux-gnu.2.17.tar.gz` |
| `aarch64-unknown-linux-gnu.2.17` | `ironcache-<ver>-aarch64-unknown-linux-gnu.2.17.tar.gz` |

The `musl` builds are fully static (no libc needed); the `gnu.2.17` builds pin a
glibc 2.17 floor for older distributions. Both carry an embedded
